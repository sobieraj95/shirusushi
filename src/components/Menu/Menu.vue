...
<template>
    <div class="menu">
        <div class="menu__content">
            <button @click="backToHomeRoute" style="color:red;">BACK</button>
            <div class=" menu__nav">
            ...
            <div class="menu__items">
                <div class="menu__item" v-for=" menu  in  getMenuByCategory(cat.name)" :key="menu.name">
                    ...
                    <div class="menu__item-add-buttons">
                        ...
                        <div class="menu__item-add-button" @click="addToNotepad(menu, true)" v-if="menu.priceAdditional">
                            Dodaj do notatnika
